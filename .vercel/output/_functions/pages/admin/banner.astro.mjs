...
const $$Banner = createComponent(async ($$result, $$props, $$slots) => {
  return renderTemplate(_a || (_a = __template(['<html lang="en"> <head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>Banner Manager Supabase</title><!-- Tailwind CSS via CDN -->', "", `</head> <div class="flex flex-col lg:flex-row gap-6"> <!-- Daftar banner/kartu --> <div id="banner-container" class="flex-1 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4"> <!-- JS akan render di sini --> </div> <!-- Side form untuk tambah/edit --> <div class="w-full lg:w-80 bg-white rounded-lg shadow p-4"> <h3 class="text-lg font-medium text-gray-800 mb-4">Tambah / Edit Banner</h3> <form id="banner-form" class="flex flex-col space-y-3"> <!-- Hidden field untuk id (edit) --> <input type="hidden" id="banner-id"> <div> <label for="banner-nama" class="block text-sm font-medium text-gray-700">Nama Banner</label> <input type="text" name="nama" id="banner-nama" class="mt-1 w-full border border-gray-300 rounded px-2 py-1 focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Masukkan nama banner"> </div> <div> <label for="banner-gambar" class="block text-sm font-medium text-gray-700">Pilih Gambar (jpg/png)</label> <input type="file" accept="image/*" name="gambar" id="banner-gambar" class="mt-1 w-full"> </div> <div> <label class="block text-sm font-medium text-gray-700">Preview Gambar</label> <img id="banner-preview" src="" alt="Preview" class="w-full h-32 object-cover rounded border mt-1 bg-gray-50"> </div> <div class="flex justify-end space-x-2 pt-2"> <button type="button" id="btn-reset" class="px-3 py-1 bg-gray-300 rounded hover:bg-gray-400">Reset</button> <button type="submit" class="px-3 py-1 bg-green-500 text-white rounded hover:bg-green-600">Submit</button> </div> </form> </div> </div> <!-- Script Supabase & logic --> <script type="module">
  ...
  <\/script> </html>`], ['<html lang="en"> <head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>Banner Manager Supabase</title><!-- Tailwind CSS via CDN -->', "", `</head> <div class="flex flex-col lg:flex-row gap-6"> <!-- Daftar banner/kartu --> <div id="banner-container" class="flex-1 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4"> <!-- JS akan render di sini --> </div> <!-- Side form untuk tambah/edit --> <div class="w-full lg:w-80 bg-white rounded-lg shadow p-4"> <h3 class="text-lg font-medium text-gray-800 mb-4">Tambah / Edit Banner</h3> <form id="banner-form" class="flex flex-col space-y-3"> <!-- Hidden field untuk id (edit) --> <input type="hidden" id="banner-id"> <div> <label for="banner-nama" class="block text-sm font-medium text-gray-700">Nama Banner</label> <input type="text" name="nama" id="banner-nama" class="mt-1 w-full border border-gray-300 rounded px-2 py-1 focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Masukkan nama banner"> </div> <div> <label for="banner-gambar" class="block text-sm font-medium text-gray-700">Pilih Gambar (jpg/png)</label> <input type="file" accept="image/*" name="gambar" id="banner-gambar" class="mt-1 w-full"> </div> <div> <label class="block text-sm font-medium text-gray-700">Preview Gambar</label> <img id="banner-preview" src="" alt="Preview" class="w-full h-32 object-cover rounded border mt-1 bg-gray-50"> </div> <div class="flex justify-end space-x-2 pt-2"> <button type="button" id="btn-reset" class="px-3 py-1 bg-gray-300 rounded hover:bg-gray-400">Reset</button> <button type="submit" class="px-3 py-1 bg-green-500 text-white rounded hover:bg-green-600">Submit</button> </div> </form> </div> </div> <!-- Script Supabase & logic --> <script type="module">
    import { createClient } from 'https://cdn.jsdelivr.net/npm/@supabase/supabase-js/+esm';
  ...
  <\/script> </html>`])), renderScript($$result, "Z:/WEB/kp-dyesablon-main/src/components/admin/Banner.astro?astro&type=script&index=0&lang.ts"), renderHead());
}, "Z:/WEB/kp-dyesablon-main/src/components/admin/Banner.astro", void 0);

const $$Index = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layoutadmin, { "title": "Banner" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main> ${renderComponent($$result2, "Banner", $$Banner, {})} </main> ` })}`;
}, "Z:/WEB/kp-dyesablon-main/src/pages/admin/banner/index.astro", void 0);

const $$file = "Z:/WEB/kp-dyesablon-main/src/pages/admin/banner/index.astro";
