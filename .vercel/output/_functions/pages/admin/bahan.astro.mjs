...
const $$Bahan = createComponent(async ($$result, $$props, $$slots) => {
  return renderTemplate(_a || (_a = __template(['<html lang="en"> <head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>Bahan Manager Supabase</title><!-- Tailwind CSS via CDN atau build pipeline -->', "", `</head> <div class="flex flex-col lg:flex-row gap-6"> <!-- Daftar bahan/kartu --> <div id="bahan-container" class="flex-1 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4"> <!-- JS akan render di sini --> </div> <!-- Side form untuk tambah/edit --> <div class="w-full lg:w-96 bg-white rounded-lg shadow p-4"> <h3 id="form-title" class="text-lg font-medium text-gray-800 mb-4">Tambah Bahan</h3> <form id="bahan-form" class="flex flex-col space-y-3"> <!-- Hidden field untuk id (edit) --> <input type="hidden" id="bahan-id"> <div> <label for="bahan-nama" class="block text-sm font-medium text-gray-700">Nama Bahan</label> <input type="text" name="nama" id="bahan-nama" class="mt-1 w-full border border-gray-300 rounded px-2 py-1 focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Masukkan nama bahan"> </div> <div> <label for="bahan-desk" class="block text-sm font-medium text-gray-700">Deskripsi</label> <textarea name="desk" id="bahan-desk" rows="3" class="mt-1 w-full border border-gray-300 rounded px-2 py-1 focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Masukkan deskripsi bahan"></textarea> </div> <div> <label for="bahan-gambar" class="block text-sm font-medium text-gray-700">Pilih Gambar (opsional)</label> <input type="file" accept="image/*" name="gambar" id="bahan-gambar" class="mt-1 w-full"> </div> <div> <label class="block text-sm font-medium text-gray-700">Preview Gambar</label> <img id="bahan-preview" src="" alt="Preview" class="w-full h-40 object-cover rounded border mt-1 bg-gray-50"> </div> <div class="flex justify-end space-x-2 pt-2"> <button type="button" id="btn-reset" class="px-3 py-1 bg-gray-300 rounded hover:bg-gray-400">Reset</button> <button type="submit" id="btn-submit" class="px-3 py-1 bg-green-500 text-white rounded hover:bg-green-600">Submit</button> </div> </form> </div> </div> <!-- Script Supabase & logic --> <script type="module">
  ...
  <\/script> </html>`], ['<html lang="en"> <head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>Bahan Manager Supabase</title><!-- Tailwind CSS via CDN atau build pipeline -->', "", `</head> <div class="flex flex-col lg:flex-row gap-6"> <!-- Daftar bahan/kartu --> <div id="bahan-container" class="flex-1 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4"> <!-- JS akan render di sini --> </div> <!-- Side form untuk tambah/edit --> <div class="w-full lg:w-96 bg-white rounded-lg shadow p-4"> <h3 id="form-title" class="text-lg font-medium text-gray-800 mb-4">Tambah Bahan</h3> <form id="bahan-form" class="flex flex-col space-y-3"> <!-- Hidden field untuk id (edit) --> <input type="hidden" id="bahan-id"> <div> <label for="bahan-nama" class="block text-sm font-medium text-gray-700">Nama Bahan</label> <input type="text" name="nama" id="bahan-nama" class="mt-1 w-full border border-gray-300 rounded px-2 py-1 focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Masukkan nama bahan"> </div> <div> <label for="bahan-desk" class="block text-sm font-medium text-gray-700">Deskripsi</label> <textarea name="desk" id="bahan-desk" rows="3" class="mt-1 w-full border border-gray-300 rounded px-2 py-1 focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Masukkan deskripsi bahan"></textarea> </div> <div> <label for="bahan-gambar" class="block text-sm font-medium text-gray-700">Pilih Gambar (opsional)</label> <input type="file" accept="image/*" name="gambar" id="bahan-gambar" class="mt-1 w-full"> </div> <div> <label class="block text-sm font-medium text-gray-700">Preview Gambar</label> <img id="bahan-preview" src="" alt="Preview" class="w-full h-40 object-cover rounded border mt-1 bg-gray-50"> </div> <div class="flex justify-end space-x-2 pt-2"> <button type="button" id="btn-reset" class="px-3 py-1 bg-gray-300 rounded hover:bg-gray-400">Reset</button> <button type="submit" id="btn-submit" class="px-3 py-1 bg-green-500 text-white rounded hover:bg-green-600">Submit</button> </div> </form> </div> </div> <!-- Script Supabase & logic --> <script type="module">
    import { createClient } from 'https://cdn.jsdelivr.net/npm/@supabase/supabase-js/+esm';
  ...
  <\/script> </html>`])), renderScript($$result, "Z:/WEB/kp-dyesablon-main/src/components/admin/Bahan.astro?astro&type=script&index=0&lang.ts"), renderHead());
}, "Z:/WEB/kp-dyesablon-main/src/components/admin/Bahan.astro", void 0);

const $$Index = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layoutadmin, { "title": "Bahan" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main> ${renderComponent($$result2, "Bahan", $$Bahan, {})} </main> ` })}`;
}, "Z:/WEB/kp-dyesablon-main/src/pages/admin/bahan/index.astro", void 0);

const $$file = "Z:/WEB/kp-dyesablon-main/src/pages/admin/bahan/index.astro";
const $$url = "/admin/bahan";
